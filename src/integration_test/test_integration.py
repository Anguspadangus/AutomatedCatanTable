...
pump_1 = PumpAssembly(Gate_Valve(GPIO_SETUP(6), GPIO_CONTROL_GATE, 6), DCMotor(HAT_SETUP("motor3", 0x61)), DCMotor(HAT_SETUP("motor4", 0x61)))
# Since you only have one pump, need to switch
mount = Mount(Stepper(200, 40, HAT_SETUP('stepper1', 0x61), HAT_CONTROL), pump_1, None)
